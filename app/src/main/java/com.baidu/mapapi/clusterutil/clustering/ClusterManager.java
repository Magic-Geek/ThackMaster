...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public interface ControlCityOverlay{
        void hideCity();
        void showCity();
    }

    ControlCityOverlay controlCityOverlay;

    public void setControlCityOverlayInterface(ControlCityOverlay controlCityOverlay){
        this.controlCityOverlay = controlCityOverlay;
    }
